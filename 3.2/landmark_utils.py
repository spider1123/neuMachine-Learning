...
def auto_detect_landmarks(image_path, num_landmarks=98):
    """
...
def generate_landmarks_for_dataset(image_paths, landmark_dir=None, num_landmarks=98, auto_detect=False):
    """
    为数据集生成关键点标注
