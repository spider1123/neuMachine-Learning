...
class LandmarkHead(nn.Module):
    ...
    """
    def __init__(self, in_channels=2048, num_landmarks=98, heatmap_size=56):
        """
        Args:
...
if __name__ == '__main__':
    # 测试LandmarkHead
    head = LandmarkHead(in_channels=2048, num_landmarks=98, heatmap_size=56)
